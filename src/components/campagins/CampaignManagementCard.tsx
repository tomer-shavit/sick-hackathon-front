...
const CampaignManagementCard: React.FC<CampaignManagementCardProps> = ({
  ...
  return (
    <div className="dark:bg-gray-8 mb-4 rounded-lg bg-white p-4 shadow-md dark:border-dark-3">
      ...
      <div className="my-2 flex items-center space-x-2">
        <span
          className={`rounded-full px-2 py-1 text-sm ${status === "Active" ? "bg-green-200 text-green-800" : "bg-yellow-200 text-yellow-800"}`}
        >
          {status}
        </span>
      </div>
